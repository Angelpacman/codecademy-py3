...
#Have the "name" key be the name of the student (that is, lloyd's name should be "Lloyd") and
#the other keys should be an empty list (We'll fill in these lists soon!)
